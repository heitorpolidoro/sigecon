...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('DIRETOR', 'FUNCIONARIO', name='userrole'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'IN_PROGRESS', 'COMPLETED', 'CANCELED', name='taskstatus'), nullable=False),
