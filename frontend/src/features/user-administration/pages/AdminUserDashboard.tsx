...
const AdminUserDashboard: React.FC = () => {
  ...
  if (isLoading) return <div className="admin-container">Carregando usuários...</div>;
  if (error) return <div className="admin-container">Erro ao carregar usuários.</div>;
    ...
    <div className="admin-container">
      <header className="admin-header">
        ...
        <div className="header-actions">
          <Link to="/dashboard" className="action-btn">Voltar ao Dashboard</Link>
