...
describe('AuthContext', () => {
  ...
  it('fetches user if token exists in localStorage', async () => {
    const mockUser = { id: 1, username: 'testuser', role: 'FUNCIONARIO', is_active: true };
  ...
  it('logs out and clears localStorage', async () => {
    ...
    await waitFor(() => expect(screen.getByTestId('auth-status').textContent).toBe('Not Authenticated'));
